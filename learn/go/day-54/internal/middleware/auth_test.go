...
import (
	...
	"learn/go/day-54/internal/repository/memory"
)
...
func TestRequireRole_Forbidden(t *testing.T) {
	...
	chain := middleware.RequireAuth(authStore)(middleware.RequireRole(auth.RoleAdmin)(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
	})))
