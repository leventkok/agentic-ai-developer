...
import (
	...
	"learn/go/day-61/internal/auth"
	"learn/go/day-61/internal/httpapi"
	"learn/go/day-61/internal/repository/memory"
...
func TestCreateBookmark_MissingTitle(t *testing.T) {
	h := httpapi.NewBookmarkHandler(service.NewBookmarkService(memory.New(nil), 100*time.Millisecond))
