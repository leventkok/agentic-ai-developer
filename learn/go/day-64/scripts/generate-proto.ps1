# Generate Go code from .proto files (Day 64)
# Run from learn/go/day-64/
...
& $protoc `
    ...
    --go_out=internal/gen `
    --go_opt=module=learn/go/day-64/internal/gen `
    --go-grpc_out=internal/gen `
    --go-grpc_opt=module=learn/go/day-64/internal/gen `
