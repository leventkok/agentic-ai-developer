...
import (
	...
	"learn/go/day-74/internal/auth"
	"learn/go/day-74/internal/clock"
	"learn/go/day-74/internal/config"
	"learn/go/day-74/internal/db"
	bookmarksv1 "learn/go/day-74/internal/gen/bookmarksv1"
	"learn/go/day-74/internal/grpcapi"
	"learn/go/day-74/internal/httpapi"
	"learn/go/day-74/internal/repository/sqlite"
	"learn/go/day-74/internal/repository/resilient"
	"learn/go/day-74/internal/service"
)
...
func Wire(cfg config.Config) (*Runtime, error) {
	...
	bookmarkRepo := resilient.NewBookmarks(sqliteStore)
