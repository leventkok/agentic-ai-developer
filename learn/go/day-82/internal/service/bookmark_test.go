...
import (
	...
	"learn/go/day-82/internal/domain"
	"learn/go/day-82/internal/service"
	"learn/go/day-82/internal/service/testing/fake"
)

func TestBookmarkService_Create_Succeeds(t *testing.T) {
	svc := service.NewBookmarkService(fake.NewBookmarks(), time.Second)
...
func TestBookmarkService_List_ReturnsBookmarks(t *testing.T) {
	...
	svc := service.NewBookmarkService(repo, time.Second)
...
func TestBookmarkService_List_RespectsTimeout(t *testing.T) {
	...
	svc := service.NewBookmarkService(repo, 50*time.Millisecond)
