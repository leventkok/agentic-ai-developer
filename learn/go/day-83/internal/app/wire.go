...
import (
	...
	"learn/go/day-83/internal/auth"
	"learn/go/day-83/internal/clock"
	"learn/go/day-83/internal/config"
	"learn/go/day-83/internal/db"
	bookmarksv1 "learn/go/day-83/internal/gen/bookmarksv1"
	"learn/go/day-83/internal/grpcapi"
	"learn/go/day-83/internal/httpapi"
	"learn/go/day-83/internal/repository"
	"learn/go/day-83/internal/repository/cached"
	"learn/go/day-83/internal/repository/sqlite"
	"learn/go/day-83/internal/repository/resilient"
...
func Wire(cfg config.Config) (*Runtime, error) {
	...
	bookmarkSvc := service.NewBookmarkService(bookmarkRepo, time.Duration(cfg.ListTimeoutMS)*time.Millisecond, eventBus)
