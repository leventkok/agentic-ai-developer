...
func TestBookmarkService_Create_Succeeds(t *testing.T) {
	svc := service.NewBookmarkService(fake.NewBookmarks(), time.Second, nil)
...
func TestBookmarkService_List_ReturnsBookmarks(t *testing.T) {
	...
	svc := service.NewBookmarkService(repo, time.Second, nil)
...
func TestBookmarkService_List_RespectsTimeout(t *testing.T) {
	...
	svc := service.NewBookmarkService(repo, 50*time.Millisecond, nil)
