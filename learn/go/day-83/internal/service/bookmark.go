...
func NewBookmarkService(repo repository.Bookmarks, listTimeout time.Duration, events messaging.Bus) *BookmarkService {
	return &BookmarkService{Repo: repo, ListTimeout: listTimeout, Events: events}
}
