...
import (
	...
	"learn/go/day-41/internal/config"
	"learn/go/day-41/internal/db"
	"learn/go/day-41/internal/handler"
	"learn/go/day-41/internal/middleware"
	"learn/go/day-41/internal/store"
)
...
func main() {
	...
	if err := db.Migrate(database, "migrations/001_init.sql"); err != nil {
		log.Fatal(err)
	}
