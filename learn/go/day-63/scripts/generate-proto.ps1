# Generate Go code from .proto files (Day 63)
# Run from learn/go/day-63/
...
& $protoc `
    ...
    --go_out=internal/gen `
    --go_opt=module=learn/go/day-63/internal/gen `
    --go-grpc_out=internal/gen `
    --go-grpc_opt=module=learn/go/day-63/internal/gen `
