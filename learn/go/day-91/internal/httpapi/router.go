...
import (
	...
	"learn/go/day-91/internal/domain"
	"learn/go/day-91/internal/middleware"
...
func NewRouter(d Deps) http.Handler {
	...
	if bookmarkSvc == nil {
		bookmarkSvc = service.NewBookmarkService(d.Bookmarks, time.Duration(d.Cfg.ListTimeoutMS)*time.Millisecond, nil, nil)
	}
